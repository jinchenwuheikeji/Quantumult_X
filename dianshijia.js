...
http-request http:\/\/api\.gaoqingdianshi\.com\/api\/v5\/sign\/signin script-path=https://raw.githubusercontent.com/Sunert/Scripts/master/Task/dianshijia.js, timeout=10, tag=电视家
...
电视家 = type=http-request,pattern=http:\/\/api\.gaoqingdianshi\.com\/api\/v5\/sign\/signin,script-path=https://raw.githubusercontent.com/Sunert/Scripts/master/Task/dianshijia.js
...
function signinfo() {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
    let awardurl = { url: `http://api.gaoqingdianshi.com/api/v5/sign/get`, headers: JSON.parse(signheaderVal)}
